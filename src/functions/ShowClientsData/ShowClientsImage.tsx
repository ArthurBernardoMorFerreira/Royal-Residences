      ...
      {(count === 1 || count > 3) && (
        <>
          <ClientImage
            ...
            src='src/assets/Image/Clients/Pexels Photo by The Lazy Artist Gallery.png'
            translateX='2.5rem'
          />
          <ClientImage
            height={isLargeScreen ? '9rem' : '7.5rem'}
            width={isLargeScreen ? '9rem' : '7.5rem'}
            src='src/assets/Image/Clients/Pexels Photo by Daniel Xavier.png'
            zIndex='1'
          />
          <ClientImage
            height={isLargeScreen ? '8rem' : '6.5rem'}
            width={isLargeScreen ? '8rem' : '6.5rem'}
            src='src/assets/Image/Clients/Pexels Photo by Andrea Piacquadio.png'
            translateX='-2.5rem'
          />
        </>
      )}
