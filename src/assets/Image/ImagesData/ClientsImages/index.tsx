...
enum ClientsImageURL {
  ClientImageURL1 = './src/assets/Image/Clients/Pexels Photo by Daniel Xavier.png',
  ClientImageURL2 = './src/assets/Image/Clients/Pexels Photo by Andrea Piacquadio.png',
  ClientImageURL3 = './src/assets/Image/Clients/Pexels Photo by The Lazy Artist Gallery.png',
}
